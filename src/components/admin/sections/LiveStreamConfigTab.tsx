...
const LiveStreamConfigTab = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">LiveStream Configuration</h2>
        <p className="text-white/60">Live streaming configuration</p>
      </div>
      ...
      <Card className="glass-morphism">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <Label>Enable LiveStream Section</Label>
            <Switch
