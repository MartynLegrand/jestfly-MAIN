...
const CommunityConfigTab = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-white mb-2">Community Configuration</h2>
        <p className="text-white/60">Community page settings</p>
      </div>
      ...
      <Card className="glass-morphism">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <Label>Enable Community Section</Label>
            <Switch
